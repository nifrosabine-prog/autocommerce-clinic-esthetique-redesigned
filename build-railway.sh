#!/usr/bin/env bash
set -euo pipefail
ARCHIVE="AutoCommerce-Clinic-recette-corrected-20260907-v2.zip"
...
if [ -d "$ROOT_DIR/AutoCommerce-Clinic-recette-final" ]; then
  ROOT_DIR="$ROOT_DIR/AutoCommerce-Clinic-recette-final"
fi
