...
_limiter_storage = None if _settings.env == "test" else (_settings.redis_url or None)
limiter = Limiter(
    key_func=get_remote_address,
    storage_uri=_limiter_storage,
    # En production, Redis est obligatoire et aucun fallback mémoire n’est
    # accepté ; en test uniquement, le stockage mémoire rend les tests isolés.
    in_memory_fallback_enabled=_settings.env == "test",
