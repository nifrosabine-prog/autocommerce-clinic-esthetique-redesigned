      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="visites">
          <TabsList className="h-auto w-full max-w-full justify-start gap-1 overflow-x-auto rounded-xl border border-slate-200 bg-slate-100 p-1.5">
            <TabsTrigger value="visites" className="shrink-0 border border-transparent bg-transparent px-3 py-2 text-slate-600 hover:bg-white hover:text-slate-950 data-[state=active]:border-teal-200 data-[state=active]:bg-white data-[state=active]:text-teal-800 data-[state=active]:shadow-sm"><Calendar className="w-4 h-4 mr-2" /> Visites & Dotations</TabsTrigger>
            <TabsTrigger value="labos" className="shrink-0 border border-transparent bg-transparent px-3 py-2 text-slate-600 hover:bg-white hover:text-slate-950 data-[state=active]:border-teal-200 data-[state=active]:bg-white data-[state=active]:text-teal-800 data-[state=active]:shadow-sm"><Beaker className="w-4 h-4 mr-2" /> Laboratoires Partenaires</TabsTrigger>
          </TabsList>
