    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="mb-8 grid h-auto w-full grid-cols-2 gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1.5">
            <TabsTrigger value="injectables" className="border border-transparent bg-transparent px-3 py-2.5 text-slate-600 hover:bg-white hover:text-slate-950 data-[state=active]:border-teal-200 data-[state=active]:bg-white data-[state=active]:text-teal-800 data-[state=active]:shadow-sm">Injectables</TabsTrigger>
            <TabsTrigger value="consommables" className="border border-transparent bg-transparent px-3 py-2.5 text-slate-600 hover:bg-white hover:text-slate-950 data-[state=active]:border-teal-200 data-[state=active]:bg-white data-[state=active]:text-teal-800 data-[state=active]:shadow-sm">Consommables</TabsTrigger>
          </TabsList>
