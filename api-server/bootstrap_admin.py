...
from models.database import RoleEnum, Utilisateur, normalize_async_database_url
...
async def bootstrap(
    ...
    *,
    ...
    # Railway fournit une URL PostgreSQL standard. Le normalisateur applique
    # le dialecte asyncpg requis par SQLAlchemy avant de créer le moteur async.
