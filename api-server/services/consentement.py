...
async def verify_consent(
    ...
    if episode_id is not None or intervention_id is not None:
        await validate_episode_intervention_scope(
            db, patient_id=patient_id, clinic_id=clinic_id,
    ...
    if episode_id is not None:
        query = query.where(Consentement.episode_id == episode_id)
    if intervention_id is not None:
        query = query.where(Consentement.intervention_id == intervention_id)
