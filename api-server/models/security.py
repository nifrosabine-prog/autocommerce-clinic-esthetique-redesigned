...
class MfaChallenge(Base):
    """Challenge MFA signé, temporaire et consommable une seule fois."""
    ...
    __table_args__ = (
        Index("ix_mfa_challenges_user_expiry", "utilisateur_id", "expires_at"),
        Index("ix_mfa_challenges_active", "jti", "consumed_at", "expires_at"),
    )
